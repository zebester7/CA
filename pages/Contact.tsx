...
const Contact: React.FC = () => {
  useSEO({
    title: 'Contact Sterling & Vance | Book Your Consultation',
    description: 'Get in touch with our elite financial advisors. Schedule a confidential consultation or reach out with your inquiry.',
    keywords: 'contact, consultation booking, financial advisory contact, get in touch',
