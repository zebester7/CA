...
const About: React.FC = () => {
  useSEO({
    title: 'About Sterling & Vance | Elite Financial Advisory Firm',
    description: 'Learn about our 20+ year legacy of financial excellence. Meet our world-class team of chartered accountants and discover our commitment to strategic advisory.',
    keywords: 'about us, chartered accountants, financial advisory firm, accounting expertise, business strategy',
    ogImage: 'https://picsum.photos/seed/founders/1200/630',
  });
